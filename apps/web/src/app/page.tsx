...
const FEATURES = [
  { label: 'My Collection', href: '/collection', icon: '✨', desc: 'My Collection feature coming soon' },
  { label: 'Item Detail', href: '/collection', icon: '✨', desc: 'Item Detail feature coming soon' },
  { label: 'Wishlist', href: '/wishlist', icon: '✨', desc: 'Wishlist feature coming soon' },
  { label: 'Lending Tracker', href: '/lending', icon: '✨', desc: 'Lending Tracker feature coming soon' }
];
